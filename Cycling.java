...
public class Cycling extends AppCompatActivity implements
        OnMapReadyCallback {
    private GoogleMap map;
    private ApplicationFitnes applicationFitnes;
    private UserData userData;
    private Data.Cycling walking;
    private ImageButton startButton, pauseButton, stopButton;
    private Cycling.GetLoctaionData getLoctaionData;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        stopButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if(sport.getCyclingList()==null)
                    sport.setCyclingList(new ArrayList<Data.Cycling>());
                sport.addCycling(walking);
